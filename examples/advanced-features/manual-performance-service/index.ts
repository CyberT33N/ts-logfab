 ...
 * const config = performanceService.configurePerformanceMonitoring();
 ...
 * @see {@link ConfigurationManager} for performance configuration
...
export class ManualPerformanceService {
     ...
     * - **Configuration Manager:** Performance monitoring configuration
     ...
     * 
     * @see {@link ConfigurationManager.configurePerformanceMonitoring} for configuration details
     */
